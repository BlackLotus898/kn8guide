...
(function () {
  ...
  const KNOWN_TOP_LEVEL = ['characters','weapons','tracker','squadmaker','tierlist','beginner','banners','limited','gameguide','combat','announcements','socials','feedback','data','kn8 characters'];
